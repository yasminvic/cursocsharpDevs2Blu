...
builder.Services.AddDbContext<SQLServerContext>
    (options => options.UseSqlServer("Server=LAPTOP-EBG33A6E\\SQLEXPRESS;Database=NewsPage;User Id=sa;Password=gibi2016;TrustServerCertificate=True;Encrypt=False;"));
