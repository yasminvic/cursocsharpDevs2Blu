...
namespace Devs2Blu.LivrosProjetoMVC.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Editora,Autor")] Livros livros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Editora,Autor")] Livros livros)
        {
            if (id != livros.Id)
            {
                return NotFound();
